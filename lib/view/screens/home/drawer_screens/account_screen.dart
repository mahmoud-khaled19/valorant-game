...
class AccountScreen extends StatelessWidget {
  ...
  child: BlocBuilder<AuthCubit, AuthState>(
      builder: (context, state) {
                     ...
                     Container(
                       ...
                       child: Column(
                         children: [
                           ...
                           socialInfo(context, AppStrings.labelEmail.tr(),
                               email ?? cubit.email),
                           socialInfo(context, AppStrings.labelPhone.tr(),
                               phone ?? cubit.phone),
                           const SizedBox(
                             height: 20,
                           ),
       ...
       return const EmptyScreen(text: AppStrings.errorMessage, image: Assets.imagesNoNews);
      },
    ),
);
  }
